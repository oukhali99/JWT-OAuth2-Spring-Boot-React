                ...
                <Navbar bg="dark" data-bs-theme="dark">
                    <Container>
                        <Nav>
                            ...
                            <NavLink to="/listing" className="navbar-brand">Listings</NavLink>
                            {id === undefined ? (
                                <NavLink to="/" className="navbar-brand" onClick={() => setShowLoginModal(true)}>Login</NavLink>
                            ) : (
                                <>
                                    <NavLink to={`/user/${id}`} className="navbar-brand">Account</NavLink>
                                    <NavLink to="/" className="navbar-brand" onClick={() => logout()}>Logout</NavLink>
                                </>
                            )}
                        </Nav>
                    </Container>
